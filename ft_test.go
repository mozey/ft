...
func TestUnmarshalString(t *testing.T) {
	...
	is.NoErr(err)
	is.Equal("", string(d.String)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal("123", string(d.String)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal("0", string(d.String)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal("123.456", string(d.String)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal("true", string(d.String)) // Value must match

	b = []byte(`{"string": false}`)
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal("false", string(d.String)) // Value must match
}
...
func TestUnmarshalInt(t *testing.T) {
	...
	err := json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(int64(0), int64(d.Int)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(int64(123), int64(d.Int)) // Value must match
...
func TestUnmarshalFloat(t *testing.T) {
	...
	err := json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(float64(0), float64(d.Float)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(float64(1.618), float64(d.Float)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(float64(-1), float64(d.Float)) // Value must match
...
func TestUnmarshalBool(t *testing.T) {
	...
	err := json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(false, bool(d.Bool)) // Value must match
	...
	err = json.Unmarshal(b, &d)
	is.NoErr(err)
	is.Equal(true, bool(d.Bool)) // Value must match
